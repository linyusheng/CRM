        ...
        <!-- Alternative Content Box End -->
         ...
         <div class="contentcontainer">
            ...
            <div class="status error" id="errormessage1" style="display: none;">       		
             ...
             <s:hidden name="contactplan.user.userId" />
                    <table align="center">
                        <tr>
                            <td>
                                <label for="textfield"> <strong>联系计划名称:</strong>                                </label>                            </td>
                            <td><label for="textfield">
                                <s:textfield id="contactPlanName" name="contactplan.contactPlanName" Class="inputbox"   onblur="validateLength('联系计划名称',1,20,this,document.getElementById('errormessage1_help'),'errormessage1')"/> <span>*<span></label>                           </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <label for="textfield">
                                <s:select name="contactplan.enterprise.enterpriseId" list="enterprises" listKey="enterpriseId" listValue="enterpriseName"/> <span>*<span> </label>                    
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td valign="top">
                                <label for="textfield"> <strong>联系计划内容:</strong>                                </label>                            </td>
                            <td><label for="textfield"><s:textarea id="contactPlanDesc" cssClass="inputbox  textarea"  name="contactplan.contactPlanDesc" rows="10" cols="50" onblur="validateLength('联系计划内容',0,255,this,document.getElementById('errormessage2_help'),'errormessage2')"/></label></td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                ...
                                <input type="button" value="返回" class="btnalt" onclick="{window.location.href='<s:url action="listcontactplan"></s:url>';}"/>                            </td>
                        </tr>
                    </table>      
                </s:form>  
                 </s:if>
