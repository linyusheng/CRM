...
function formSubmit(form){
    if(validateLength("联系人姓名",1,20,form["customerName"],document.getElementById("errormessage1_help"),"errormessage1")&&
        validatePersonalNumber("私人电话",form["personalNumber"],document.getElementById("errormessage2_help"),'errormessage2')){
        if(confirm("确定要提交？"))
            form.submit();
    }
    else{
...
<body id="homepage">
    ...
    <div id="breadcrumb">
        <ul>    
            ...
            <li><a href="<%=request.getContextPath()%>/listcustomer" title="">客户联系人管理</a></li>
            <li>/</li>
            <li class="current">增加客户联系人</li>
        </ul>
    </div>
    <!-- Top Breadcrumb End -->
        ...
        <!-- Alternative Content Box End -->
         ...
         <div class="contentcontainer">
            ...
            <div class="contentbox">
                ...
                <s:form action="savecustomer" method="post">
                <s:hidden name="customer.customerId" label="id" />
                <s:hidden name="customer.user.userId" />
                    <table align="center">
                        <tr>
                            ...
                            <td> 
                            	 <label for="textfield">                  
									...
									listValue="enterpriseName" id="enterpriseName"/>
									<span>*</span>
								</label>	                                           
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <label for="textfield"> <strong>联系人姓名:&nbsp;</strong></label>
                            </td>
                            <td>
                            	<label for="textfield">
                            		<s:textfield id="customerName" name="customer.customerName" cssClass="inputbox" 
                            		onblur="validateLength('联系人姓名',1,20,this,document.getElementById('errormessage1_help'),'errormessage1')" />
                            		<span>*</span>
                            	</label>
                               ...
                               <tr>
                            <td>
                                <label for="textfield"> <strong>私&nbsp;人&nbsp;电&nbsp;话:&nbsp;</strong>
                                </label>
                            </td>
                            <td>
                            	<label for="textfield">
                            		<s:textfield id="personalNumber" name="customer.personalNumber" cssClass="inputbox" 
                        ...
                        <tr>
                            ...
                            <td>
                            	<label for="textfield">
                            		<s:textfield name="customer.position" cssClass="inputbox" />  
                            	</label>                           
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                            	<label for="textfield">
                            		<s:textfield name="customer.hobby" cssClass="inputbox" /> 
                            	</label>                     
                            </td>
                        </tr>
                        <tr>
                ...
                <s:else>
                	<div style="text-align: center;font-size:18px;padding:20px;">客户不存在，请先增加客户！</div>
            		<div style="text-align: center;">
            			<input type="button" value="返回" class="btnalt" onclick="{window.location.href='<s:url action="listcustomer"></s:url>';}"/>
            		</div>
                </s:else>      
            </div>
        </div>
