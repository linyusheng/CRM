            ...
            <div class="contentbox">
            	<form action="#">
                    <table align="center">
					    <tr>
                            <td>
                                <label for="textfield"> <strong>联&nbsp;&nbsp;系&nbsp;&nbsp;编&nbsp;&nbsp;号:&nbsp;&nbsp;</strong>
                                </label>
                            </td>
                            <td><label for="textfield">
                               <s:property value="contactnote.contactNoteId"/> </label>                
                            </td>
                        </tr>
						 <tr>
                            <td>
                            ...
                            <td><label for="textfield">
                               <s:property value="contactnote.enterprise.enterpriseName"/></label>              
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td><label for="textfield">
                                 <s:property value="contactnote.contactNoteName"/></label>          
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td><label for="textfield">
                                <s:date name="contactnote.contactDate" format="yyyy-MM-dd"/></label>            
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <s:textarea  cssClass="inputbox  textarea" readonly="true" name="contactnote.contactDesc" rows="10" cols="50"/> 
                            </td>
                        </tr>
                        <tr>
                            <td>
