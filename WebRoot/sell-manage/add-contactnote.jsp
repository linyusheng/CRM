...
function formSubmit(form){
    ...
    if(validateLength('联系记录名称',1,20,form["contactNoteName"],document.getElementById('errormessage1_help'),'errormessage1')&&
       ...
       validateLength('联系描述',0,255,this,document.getElementById('errormessage3_help'),'errormessage3')&& 
            ...
            <s:form action="savecontactnote" method="post">
             <s:hidden id="contactNoteId" name="contactnote.contactNoteId" label="ID"></s:hidden>
                    ...
                    <table align="center">
                        <tr>
                            <td>
                                <label for="textfield"> <strong>联系记录名称:</strong>
                                </label>
                            </td>
                            <td><label for="textfield">
                                <s:textfield type="text" id="contactNoteName" cssClass="inputbox" name="contactnote.contactNoteName" onblur="validateLength('联系记录名称',1,20,this,document.getElementById('errormessage1_help'),'errormessage1')"/><span>*<span></label>                    
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <label for="textfield"> <strong>联系记录时间:</strong></label>
                            </td>
                            <td><label for="textfield">
                                <s:textfield  id="contactDate" readonly="true" cssClass="inputbox smallbox" name="contactnote.contactDate" onclick="fPopCalendar(event,this,this)" onfocus="this.select()"  /><span>*<span>								
                       			</label>
                            </td>
                        </tr>
                               <tr>
                        ...
                        <tr>
                            <td valign="top">
                                <label for="textfield"> <strong>联&nbsp;&nbsp;系&nbsp;&nbsp;描&nbsp;&nbsp;述:&nbsp;</strong>
                                </label>
                            </td>
                            <td><label for="textfield">
                            <s:textarea id="contactDesc"  cssClass="inputbox  textarea" name="contactnote.contactDesc" rows="10" cols="50" onblur="validateLength('联系描述',0,255,this,document.getElementById('errormessage3_help'),'errormessage3')"/> 
                             </label>
                            </td>
                        </tr>
                        <tr>
