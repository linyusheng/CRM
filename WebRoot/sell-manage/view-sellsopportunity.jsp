        ...
        <!-- Alternative Content Box End -->
         ...
         <div class="contentcontainer">
            ...
            <div class="contentbox">
            	<s:form id="form1" action="loadsellsopportunity" method="post">
            	<table align="center">
            		<tr>
            			<td>
            		...
            		<tr>
            			...
            			<td>
            				<s:label id="sellsOpportunityId" name="sellsopportunity.sellsOpportunityName" />
            			</td>
            		</tr>
            		<tr>
            			<td>
            				<label for="textfield"><strong>客户联系人编号:&nbsp;</strong></label>
            			</td>
            			<td>
            				<s:label id="customerId" name="sellsopportunity.customer.customerId" />
            			</td>
            		</tr>
            		<tr>
            			<td>
            			...
            			<td>
            				<s:label id="customerId" name="sellsopportunity.customer.customerName" />
            			</td>
            		</tr>
            		<tr>
            			<td>
            			...
            			<td>
            				<label for="textfield">
            					<s:date name="sellsopportunity.nextCallTime" format="yyyy-MM-dd" />
            				</label>
            			</td>
            		</tr>
            		<tr>
            			...
            			<td>
            				<s:label id="sellsOpportunityName" name="sellsopportunity.sellsOpportunityName" />
            			</td>
            		</tr>
            		<tr>
            			<td>
            			...
            			<td>
            				<s:textarea id="sellsOpportunityDesc" name="sellsopportunity.sellsOpportunityDesc" readonly="true" rows="10" cols="50" />
            			</td>
            		</tr>
            		<tr>
            			<td></td>
