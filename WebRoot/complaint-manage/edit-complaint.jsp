...
function formSubmit(form){	
	...
	&&('投诉人',1,20,form["complaintName"],document.getElementById('errormessage2_help'),'errormessage2')
        ...
        <!-- Alternative Content Box End -->
         ...
         <div class="contentcontainer">
            ...
            <div class="contentbox">
            	...
            	<s:hidden name="complaint.CState" />
            	<s:hidden name="complaint.userByServerId.userId"/>
            	<s:hidden name="complaint.userByUserId.userId"/>            	
                    <table align="center">
                        <tr>
                            <td>
                                <label for="textfield"> 
                        ...
                        <tr>
                          ...
                          <td><label for="textfield">
                         	<s:textfield  id="smallbox" cssClass="inputbox smallbox" name="complaint.complaintTime" readonly="true" onclick="fPopCalendar(event,this,this)" onfocus="this.select()">
                         		<s:param name="value"><s:date name="complaint.complaintTime" format="yyyy-MM-dd"/></s:param>
                         	</s:textfield> 
        				  </label></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><label for="textfield">
                            <s:textfield id="smallbox" cssClass="inputbox smallbox" name="complaint.complaintName" 
                            onblur="('投诉人',1,20,this,document.getElementById('errormessage2_help'),'errormessage2')"/></label>                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                          ...
                          <input type="button" value="返回" class="btnalt" onclick="go('${pageContext.request.contextPath}/listcomplaint');"/>                            </td>
                        </tr>
                    </table>      
                </s:form>         
            </div>
