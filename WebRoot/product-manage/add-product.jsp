...
function formSubmit(form){
    if(validateLength('产品名称',1,20,form["name"],document.getElementById('errormessage1_help'),'errormessage1')&&validateLength('产品描述',1,255,form["productDesc"],document.getElementById('errormessage2_help'),'errormessage2')){
        if(confirm("确定要提交？"))
            form.submit();
    }
    else{
         ...
         <div class="contentcontainer">
            ...
            <div class="status error" id="errormessage1" style="display: none;">       		
         	...
         	<div class="status success" id="successmessage" style="display: none;">
        	  ...
        	  <s:if test="productcategoryColl.size() > 0">
            	 <s:form  action="saveproduct" method="post" id="form1">
                    <table align="center">
                        ...
                        <tr>
                            ...
                            <td><label for="textfield">
                                <s:textfield name="product.productName"  id="name" cssClass="inputbox" onblur="validateLength('产品名称',1,20,this,document.getElementById('errormessage1_help'),'errormessage1')"  />         <span>*<span>                 
                           </label>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td> <label for="textfield">
                               <s:select name="product.productcategory.productCategoryId" list="productcategoryColl" listKey="productCategoryId" listValue="categoryName"  /><span>*<span> 
                           </label>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><label for="textfield"> 
                                <s:textarea cssClass="inputbox textarea" id="productDesc" name="product.productDesc" rows="10" cols="50" onblur="validateLength('产品描述',1,230,this,document.getElementById('errormessage2_help'),'errormessage2')"  ></s:textarea>
                           <span>*<span> </label>
                            </td>
                        </tr>
                        <tr>
                ...
                <s:else>
                <div style="text-align: center;font-size:18px;padding:20px;">产品类别不存在，请先增加产品类别！</div>
            		<div style="text-align: center;">
            			<input type="button" value="返回" class="btnalt" onclick="{window.location.href='<s:url action="listproduct"></s:url>';}"/>
            		</div>
