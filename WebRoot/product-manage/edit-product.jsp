...
<body id="homepage">
   ...
   <div id="breadcrumb">
    	<ul>	
			...
			<li><a href="<%=request.getContextPath()%>/listproduct.action" >产品信息管理</a></li>
			<li>/</li>
            <li class="current">修改产品详细信息</li>
         ...
         <div class="contentcontainer">
            ...
            <div class="status error" id="errormessage1" style="display: none;">       		
         	...
         	<div class="status success" id="successmessage" style="display: none;">
            	...
            	<s:hidden name="product.productId" label="id" />
                    <table align="center">
                       ...
                       <tr>
                            ...
                            <td  ><label for="textfield">
                                <s:textfield id="name" name="product.productName" cssClass="inputbox" onblur="validateLength('产品名称',1,20,this,document.getElementById('errormessage1_help'),'errormessage1')" />        <span>*<span>               
                                </label>
                            </td>
                        </tr>
    ...
    <tr>
                        ...
                        <tr>
                            ...
                            <td>
                            <label for="textfield">
                                <s:textarea id="productDesc" name="product.productDesc" rows="10" cols="50"   cssClass="inputbox textarea"  onblur="validateLength('产品描述',1,230,this,document.getElementById('errormessage2_help'),'errormessage2')" >  
                            </s:textarea><span>*<span> 
                            </label>
                            </td>
                        </tr>
                        <tr>
