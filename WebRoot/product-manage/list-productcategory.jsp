...
<body id="homepage">
    ...
    <div id="rightside">
        ...
        <div class="contentcontainer">
            ...
            <s:form id="removeform" action="removeproductcate" method="post">
                <table width="100%">
                    <thead>
                        <tr>
                            <th>
                                <input name="" type="checkbox" value="" id="id" /> <!-- 全选的实现在js function里面实现了 -->
                            </th>
                            <th>产品类别编号</th>
                            <th>产品类别名称</th>
                    ...
                    <tbody>
                    <s:if test="true == productcategoryColl.isEmpty()">
									<tr>
                       ...
                       <s:iterator value="productcategoryColl" status="st" >
                        <tr <s:if test="#st.even"> class="alt"</s:if>>
                       <td>
					  <input type="checkbox" name="ids" value='<s:property value="productCategoryId"/>'/>
                       </td>
                       <td><s:property value="productCategoryId"/></td>
					   <td><s:property value="categoryName"/></td>		
                       <td>
                                <a href='<s:url action="viewproductcate"><s:param name="id" value="productCategoryId"/></s:url>'><img src="${pageContext.request.contextPath}/img/icons/icon_view.png" alt="Edit" />查看</a>
                                &nbsp;
                                <a href='<s:url action="editproductcate"><s:param name="id" value="productCategoryId"/></s:url>'>  <img src="${pageContext.request.contextPath}/img/icons/icon_edit.png" alt="Edit" />修改</a>
                                &nbsp;
                                <a href='<s:url action="removeproductcate"><s:param name="ids" value="productCategoryId"/></s:url>' onclick=" return removeone();"> <img src="${pageContext.request.contextPath}/img/icons/icon_delete.png" alt="Delete" />删除</a>
                ...
                <div class="extrabottom">
                    ...
                    <ul>
                        <li>
                            <a href='<s:url action="addproductcate" ></s:url>'><img src="${pageContext.request.contextPath}/img/icons/icon_add.png" alt="add" />增加</a>
                        </li>
                        <li>
                    ...
                    <s:form id="searchForm" action="listproductcate" method="post">
                    
                                                    
                        <input type="text" placeholder=" 产品类别名称" name="KeyWord" value="<s:property value="keyWord"/>"  class="inputbox smallbox"  />&nbsp;&nbsp;
                       <a href="javascript:void(0)" onclick="keywordSearch('searchForm')"> <img src="${pageContext.request.contextPath}/img/icons/icon_search.png" alt="Search" />查找
    </a>
                       </s:form> 
                    </div>
