...
function createReport(){
	...
	var oDivProReportPie=document.getElementById('achievementReportPie');
	var oDivProReportBar=document.getElementById('achievementReportBar');
	var oDivProReportLine=document.getElementById('achievementReportLine');
	//alert(showtype);
	...
	if(inputyear==""){
		...
		return;
	     ...
	     if(showtype1!=null)
	     {
		   ...
		   oAHrefPie.href=oActionValuePie + '?inputyear=' + inputyear+'&showtype1='+showtype1;
		   oImageReportPie.src=oActionValuePie +  '?inputyear=' + inputyear+'&showtype1='+showtype1;
		...
		if(showtype2!=null)
	     {
		   ...
		   oAHrefBar.href=oActionValueBar + '?inputyear=' + inputyear+'&showtype2='+showtype2;
		   oImageReportBar.src=oActionValueBar +  '?inputyear=' + inputyear+'&showtype2='+showtype2;
		...
		if(showtype3!=null)
	     {
		   ...
		   oAHrefLine.href=oActionValueLine + '?inputyear=' + inputyear+'&showtype3='+showtype3;
		   oImageReportLine.src=oActionValueLine +  '?inputyear=' + inputyear+'&showtype3='+showtype3;
...
<body id="homepage" onload="start('inputyear')">
   ...
   <div id="breadcrumb">
    	<ul>	
			...
			<li class="current">生成公司业绩年度报表</li>
        ...
        <!-- Alternative Content Box End -->
         ...
         <div class="contentcontainer">
            ...
            <div class="contentbox">
            	...
            	<s:form method="get" id="achievement">
            	 <input id="actionValuePie" type="hidden" value="<%=basePath%>achievementpiechart" />
            	 <input id="actionValueBar" type="hidden" value="<%=basePath%>achievementbarchart" />
            	 <input id="actionValueLine" type="hidden" value="<%=basePath%>achievementlinechart" />
                    <table align="center">
                        <tr>
                            <td>
                                <label for="textfield"> 
                                   <strong>输&nbsp;&nbsp;入&nbsp;&nbsp;年&nbsp;&nbsp;份:</strong>
                                </label>
                            </td>
    ...
    <jsp:include flush="true" page="../include/user.jsp" />
        ...
        <ul id="nav">
            ...
            <li>
                <ul class="navigation">
                    <li class="heading selected"   onclick="go('${pageContext.request.contextPath}/achievement');">生成公司业绩年度报表</a></li>
