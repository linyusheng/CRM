...
function createReport(){
	...
	var oDivProReportPie=document.getElementById('productsaleReport');
	var oDivProReportBar=document.getElementById('productsaleReportBar');
	var oDivProReportLine=document.getElementById('productsaleReportLine');
	...
	if(year==""){
		...
		return;
	     ...
	     if(showtype1!=null)
	     {
		   ...
		   oAHrefPie.href=oActionValuePie + '?year=' + year+'&categoryId='+categoryId+'&showtype1='+showtype1;
		   oImageReportPie.src=oActionValuePie +  '?year=' + year+'&categoryId='+categoryId+'&showtype1='+showtype1;
		...
		if(showtype2!=null)
	     {
		   ...
		   oAHrefBar.href=oActionValueBar + '?year=' + year+'&categoryId='+categoryId+'&showtype2='+showtype2;
		   oImageReportBar.src=oActionValueBar +  '?year=' + year+'&categoryId='+categoryId+'&showtype2='+showtype2;
		...
		if(showtype3!=null)
	     {
		   ...
		   oAHrefLine.href=oActionValueLine + '?year=' + year+'&categoryId='+categoryId+'&showtype3='+showtype3;
		   oImageReportLine.src=oActionValueLine +  '?year=' + year+'&categoryId='+categoryId+'&showtype3='+showtype3;
...
<body id="homepage" onload="start('year')">
   ...
   <div id="breadcrumb">
    	<ul>	
			...
			<li class="current">生成产品销售年度报表</li>
         ...
         <div class="contentcontainer">
            ...
            <div class="status error" id="errormessage1" style="display: none;">       		
         	...
         	<div class="status success" id="successmessage" style="display: none;">
            	...
            	<s:form method="get" id="productsale">
            	
            	 
            	 <input id="actionValuePie" type="hidden" value="<%=basePath%>productsalechart" />
            	 <input id="actionValueBar" type="hidden" value="<%=basePath%>productsalebarchart" />
            	 <input id="actionValueLine" type="hidden" value="<%=basePath%>productsalelinechart" />
                    <table align="center">
                        <tr>
                            <td>
                            ...
                            <td>
                              ...
                              <!--  <s:textfield name="year" cssClass="inputbox" id="year" onblur="validateYear('输入年份',this,document.getElementById('errormessage1_help'),'errormessage1')"  />  --> 
                               <label for="textfield">                     
                        ...
                        <tr>
                            ...
                            <td> <label for="textfield">  
                                 <s:select  id="categoryId" name="categoryId" list="productcategoryColl" listKey="productCategoryId" listValue="categoryName"  />
                                 </label>
                            </td>
                        </tr>
    ...
    <div id="leftside">
        ...
        <ul id="nav">
            ...
            <li>
                 ...
                 <ul class="navigation">
                    <li class="heading selected"  onclick="go('${pageContext.request.contextPath}/productsale');">生成产品销售年度报表</li>
