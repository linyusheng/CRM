		...
		<div id="rightside">
			...
			<div class="contentcontainer">
				...
				<div class="contentbox">
					...
					<form id="problem_addform" action="saveproblem" method="post">
						<table align="center">
							<tr>
								<td>
									<label for="textfield">
								...
								<td>
									<label for="textfield">
										<input id="ProblemName" type="text"
											name="problemsolution.ProblemName" class="inputbox textarea"
							...
							<tr>
								...
								<td>
									<label for="textfield">
									<textarea id="ProblemDesc" name="problemsolution.ProblemDesc" class="inputbox textarea"
