...
function formSubmit(form){
	if(validateLength("代表人姓名",1,20,form["bossName"],document.getElementById("errormessage1_help"),"errormessage1")&&
		validateLength("企业名称",1,20,form["enterpriseName"],document.getElementById("errormessage2_help"),"errormessage2")&&
        ...
        <!-- Alternative Content Box End -->
         ...
         <div class="contentcontainer">
            ...
            <div class="contentbox">
                ...
                <s:form action="saveenterprise">
                	<s:hidden name="enterprise.enterpriseId" />
                    <table align="center">
                        <tr>
                            <td>
                                <label for="textfield"> <strong>企&nbsp;业&nbsp;编&nbsp;号:&nbsp;</strong>
                                </label>
                            </td>
                            <td>
                                 <label for="textfield"> <s:property value="enterprise.enterpriseId" />
                                </label>                       
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                            	<label for="textfield">
                                	<s:textfield id="enterpriseName" name="enterprise.enterpriseName" cssClass="inputbox" onblur="validateLength('企业名称',1,20,this,document.getElementById('errormessage2_help'),'errormessage2')" />                        
                            		<span>*</span>
                            	</label>	
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                            	<label for="textfield">
                                	<s:textfield name="enterprise.establishDate" cssClass="inputbox" readonly="true"  onclick="fPopCalendar(event,this,this)" onfocus="this.select()" >    
                                		<s:param name="value"><s:date name="enterprise.establishDate" format="yyyy-MM-dd"/></s:param>
                                	</s:textfield>
                                </label>	                    
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <label for="textfield">
                                	...
                                	<input type="button" value="返回" class="btnalt" onclick="{window.location.href='<s:url action="listenterprise"></s:url>';}" />                            
                            	</label>
                            </td>
                        </tr>
                    </table>      
