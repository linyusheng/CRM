        ...
        <!-- Alternative Content Box End -->
         ...
         <div class="contentcontainer">
            ...
            <div class="status error" id="errormessage1" style="display: none;">
                ...
                <form id="commonproblem_editform" action="savecommonproblem">
                <s:hidden name="commonproblem.commonProblemId" label="Id" />
                    <table align="center">
                        <tr>
                            ...
                            <td>
                            	<label for="textfield">
                                	<s:property value="commonproblem.commonProblemName" /> &nbsp;                    
                            	</label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                            	<label for="textfield">
                            		<s:textarea id="commonProblemDesc" name="commonproblem.commonProblemDesc" readonly="true" rows="10" cols="50" cssClass="inputbox textarea" onblur="validateLength('问题描述',1,200,this,document.getElementById('errormessage2_help'),'errormessage2')"/>                     
                            	</label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                            	<label for="textfield">
                            		<s:textarea id="commonSolutionDesc" name="commonproblem.commonSolutionDesc" readonly="true" rows="10" cols="50" cssClass="inputbox" onblur="validateLength('解决描述',1,200,this,document.getElementById('errormessage3_help'),'errormessage3')"/> 
                            	</label>
                            </td>
                        </tr>
                        <tr>
