...
<body id="homepage">
    <div id="header">
        <a href="${pageContext.request.contextPath}/index.jsp" title=""><img src="${pageContext.request.contextPath}/img/cp_logo.png" alt="四川铁航客户关系管理系统logo" class="logo" /></a>
    </div>
         ...
         <div class="contentcontainer">
            <div class="headings alt">
				...
				<div class="contentbox">
					...
					<form id="commonproblem_addform" action="savecommonproblem"
						method="post">
						<table align="center">
							<tr>
								<td>
								...
								<td>
									<label for="textfield">
										<input type="text" id="commonProblemName" class="inputbox"
										name="commonproblem.commonProblemName"
										onblur="validateLength('问题名称',1,20,this,document.getElementById('errormessage1_help'),'errormessage1')" />
									<span>*<span></label>
								</td>
							</tr>
							<tr>
								...
								<td>
									<label>
										<textarea id="commonProblemDesc" name="commonproblem.commonProblemDesc" class="inputbox"
										rows="10" cols="50"  onblur="validateLength('问题描述',1,200,this,document.getElementById('errormessage2_help'),'errormessage2')"></textarea>
									<span>*<span></label>
							...
							<tr>
								...
								<td>
									<label for="textfield">
									<textarea id="commonSolutionDesc" name="commonproblem.commonSolutionDesc" class="inputbox textarea"
										rows="10" cols="50"  onblur="validateLength('解决描述',1,200,this,document.getElementById('errormessage3_help'),'errormessage3')"></textarea>
									<span>*<span></label>
								</td>
							</tr>
							<tr>
